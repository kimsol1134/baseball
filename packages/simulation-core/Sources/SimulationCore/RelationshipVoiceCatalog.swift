    ...
    public static let scenes: [String: Scene] = [
        ...
        "evt-new-catcher": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}전 학교 사인이 손에 더 붙어. 근데 네가 편한 쪽으로 가자. 나는 맞출 수 있어.\u{201D}",
            ],
            choices: [
        ...
        "evt-arm-care": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}팔이 무거워. 네가 참는 편인 거 아니까 내가 먼저 말한다. 오늘은 어떻게 할까?\u{201D}",
            ],
            choices: [
        ...
        "evt-fan-letter": Scene(
            ...
            quotes: [
                ...
                .mid: "\u{201C}선수님이 던지는 그 느린 공이 제일 좋아요. 다음 경기에도 꼭 던져 주세요!\u{201D} 삐뚤빼뚤한 글씨 밑에 그림도 그려져 있다.",
        ...
        "evt-exam-week": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}시험이랑 원정이 겹쳤더라. 네가 알아서 할 거 아니까 길게 말 안 한다. 며칠만.\u{201D}",
            ],
            choices: [
        ...
        "evt-loss-interview": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}마지막 그 공, 노리고 던진 거죠? 그 판단이 궁금해서 기다렸습니다.\u{201D}",
            ],
            choices: [
        ...
        "evt-national-stage": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}오늘은 너를 중심으로 간다. 평소대로만 하면 그림은 알아서 나와.\u{201D}",
            ],
            choices: [
        ...
        "evt-captain-talk": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}다음 경기는 네가 길게 가 줘야 해. 다들 그렇게 생각하고 있어.\u{201D}",
            ],
            choices: [
        ...
        "evt-scout-question": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}지난달 그 경기 뒤로 확실히 달라졌더라. 뭘 바꿨는지 듣고 싶어서 왔다.\u{201D}",
            ],
            choices: [
        ...
        "evt-bullpen-rival": Scene(
            ...
            quotes: [
                ...
                .high: "\u{201C}그 그립 좀 보여줘. 대신 내 슬라이더 쥐는 법 알려줄게. 서로 늘어야 팀이 산다.\u{201D}",
            ],
            choices: [
