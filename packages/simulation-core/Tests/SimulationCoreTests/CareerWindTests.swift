...
final class CareerWindTests: XCTestCase {
    ...
    func testV2PoolMatchesLaunchRulesAndGeneratedDescriptions() throws {
        ...
        let expectedDescriptions: [String: [String]] = [
            "calm": [],
            "monster_generation": ["팬 관심 획득 +3", "숙적 능력 +5", "야구혼 보정 +15%"],
            "scout_frenzy": ["시작 팬 관심 10"],
            "quiet_season": ["시작 팬 관심 0", "숙적 능력 -3", "야구혼 보정 +8%"],
            "heatwave": ["회복 효과 +4", "모든 훈련 피로 +2", "야구혼 보정 +12%"],
            "command_year": ["제구 훈련 성장 +1", "구위 훈련 피로 +1", "야구혼 보정 +5%"],
            "power_year": ["구위 훈련 성장 +1", "숙적 능력 +3", "야구혼 보정 +10%"],
            "battery_year": ["포수 믿음 변화 +2", "시작 팬 관심 2", "야구혼 보정 +5%"],
            "spotlight_year": ["팬 관심 획득 +2", "대화 실패 때 믿음 손실 +2", "야구혼 보정 +8%"],
            "underdog_year": ["드래프트 평가 +1", "시작 팬 관심 0", "숙적 능력 +2", "야구혼 보정 +12%"],
        ]
