...
public struct HighSchoolCareerSaveRecord: Codable {
    ...
    public var chapterGains: [String: Int]? = nil
    public var chapterTrainingCount: Int? = nil
    ...
    public var creditedExternalRewardIDs: Set<String>? = nil
    /// 현재 회차의 약속 결정·숙적 원장. 없는 옛 저장본은 기존 UserDefaults를 migration
    /// source로 사용하고, 다음 저장부터 이 필드에 함께 싣는다.
    public var currentCareerRetention: CurrentCareerRetention? = nil
    ...
    public init(
        ...
        archive: [LifeRecord]? = nil,
        enteredProCareerID: String? = nil,
        nicknames: [Nickname]? = nil,
        chronicle: [ChronicleEntry]? = nil,
        chapterStartStrikeouts: Int? = nil,
        goalCelebratedChapter: Int? = nil,
        responseTally: ResponseTally? = nil,
        bondMemories: [PlayerBondMemory]? = nil,
        rebirthEventIDs: [String]? = nil,
        chapterGains: [String: Int]? = nil,
        chapterTrainingCount: Int? = nil,
        ...
        creditedExternalRewardIDs: Set<String>? = nil,
        currentCareerRetention: CurrentCareerRetention? = nil,
...
public enum HighSchoolCareerRestoreOutcome: Equatable {
