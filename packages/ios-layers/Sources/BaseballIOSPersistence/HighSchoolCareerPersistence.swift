...
public enum HighSchoolCareerPersistence {
    public static let currentSchemaVersion = 4

    public static func decode(_ data: Data) -> HighSchoolCareerSaveRecord? {
    ...
    public static func encode(_ record: HighSchoolCareerSaveRecord) -> Data? {
    ...
    public static func migratedInheritance(
    ...
    public enum ChapterStartFallback {
        case zero
    ...
    public static func record(
        ...
        HighSchoolCareerSaveRecord(
            ...
            bondMemories: PlayerBondMemory.normalized(state.bondMemories).isEmpty
                ? nil : PlayerBondMemory.normalized(state.bondMemories),
    ...
    public static func materialize(
        ...
        return HighSchoolCareerPersistedState(
            ...
            bondMemories: PlayerBondMemory.normalized(record.bondMemories ?? []),
