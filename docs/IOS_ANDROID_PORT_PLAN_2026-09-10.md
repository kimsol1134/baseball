...
| Phase 2 프로 규칙 10→13 | **완료 — `currentRulesVersion` 13** | `e62f2618`(자리) + 이후 커밋들. 자책점 원장·수비 실책·승계 주자 정산·투구 수 피로·교체 규칙까지 올렸고 등판 단위 밸런스는 안드로이드 근처에 들어왔다. 커리어 단위 밴드가 아직 안 맞아 `currentRulesVersion`은 10 그대로다. 아래 §2.1·§2.2 |
