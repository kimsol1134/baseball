...
| 16KB page | `getconf PAGE_SIZE=16384`, ARM64, API 35+ | 미확보 | 출시 차단 | AAB alignment만으로 대체 금지 |
...
16KB 행은 smoke `device-metadata.txt`의 `native_page_size=16384`, `result.txt`의
