...
describe("P4 release services", () => {
  ...
  it("validates a safe declarative content pack", () => {
    expect(validateContentPackManifest({
      format: "DiamondSoulContentPack", schemaVersion: 1, id: "community.seoul", title: "서울 이야기",
  ...
  it("rejects duplicate IDs and directory traversal", () => {
    const base = { format: "DiamondSoulContentPack", schemaVersion: 1, id: "community.safe", title: "팩", version: "1", gameVersion: "0.4", author: "A" } as const;
