...
const fixture = (revision: number): ProCareerAutosavePayload => ({ format: "DiamondSoulProCareerAutosave", schemaVersion: 1, savedAt: "2026-07-22", selectedPresetID: "power_prospect", highSchoolCareer: { snapshot: {} } as ProCareerAutosavePayload["highSchoolCareer"], proCareer: { snapshot: { revision } } as ProCareerAutosavePayload["proCareer"] });
