...
public object BaseballGlossary {
    public val terms: List<BaseballGlossaryTerm> = listOf(
        ...
        term("movement", "변화구", "공이 날카롭게 꺾이고 떨어지는 움직임. 헛스윙과 범타를 유도합니다."),
        ...
        term("baseball-spirit", "야구혼", "선수 커리어가 끝나며 남는 힘. 다음 선수의 시작 능력을 키워줍니다."),
        term("awakening", "각성", "한 장면이 투구 감각을 바꾼다."),
        term("lineage", "계보", "이전 선수가 남긴 유산이 다음 선수에게 이어집니다."),
