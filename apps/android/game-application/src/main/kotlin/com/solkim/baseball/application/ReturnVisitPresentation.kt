...
public object ReturnVisitPresentation {
    ...
    public fun screen(state: GameAggregateState): Phase8ScreenId = Phase8ScreenProjection.preferredScreen(state)
    public fun label(state: GameAggregateState): String = when (screen(state)) {
        Phase8ScreenId.P018_PRO_IMPORTANT_GAME, Phase8ScreenId.P008_IMPORTANT_GAME -> "멈춰 둔 경기"
        Phase8ScreenId.P019_PRO_SEASON -> "프로 시즌의 선택"
        Phase8ScreenId.P017_PRO_WEEK -> "프로 주간 계획"
        Phase8ScreenId.P007_RELATIONSHIP -> "진행 중인 대화"
