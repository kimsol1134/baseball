...
enum MetaUICopyKey: String, CaseIterable, Sendable {
    ...
    case fatigueStatusWordNormal = "fatigue.status.word.normal"
    case fatigueStatusWordTired = "fatigue.status.word.tired"
    case fatigueStatusWordOverwork = "fatigue.status.word.overwork"
    case fatigueStatusWordExhausted = "fatigue.status.word.exhausted"
