...
enum RecordUICopyKey: String, CaseIterable, Sendable {
    ...
    case albumTitle = "record.album.title"
    case albumPlay = "record.album.play"
    case albumView = "record.album.view"
    case albumCatcherView = "record.album.catcher-view"
    case albumStrikeout = "record.album.strikeout"
    case albumOtherScenes = "record.album.other-scenes"
    case albumEmpty = "record.album.empty"
    case albumReplayHeading = "record.album.replay.heading"
    case albumReplayAccessibility = "record.album.replay.accessibility"
    case saberTitle = "record.saber.title"
    case saberIP = "record.saber.ip"
    case saberERA = "record.saber.era"
