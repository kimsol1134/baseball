...
extension HighSchoolCareerStore {
    ...
    typealias PersistenceOverrides = HighSchoolCareerPersistenceOverrides
    ...
    func persist(
        ...
        gameResume candidateGameResume: PitchResumeState?,
    ...
    func abandonImportantGame() -> Bool {
        ...
        if countsTowardWeeklyProgram {
            CareerTelemetry.log(.gameAbandoned, [
    ...
    func perform(
        ...
        do {
            ...
            if let createdBondMemory {
                ...
                CareerTelemetry.log(.bondMemoryCreated, [
            ...
            if updated.snapshot.phase != before.phase, !isChallengeRun {
                CareerTelemetry.log(.phaseEntered, [
