    ...
    func confirmLegacy() {
        ...
        do {
            ...
            if let settledPledge, let pledgeProgress {
                CareerTelemetry.log(.runPledgeResolved, [
            ...
            if let signatureLegacy {
                CareerTelemetry.log(.signatureLegacySelected, [
            ...
            if let masteryRankUp {
                CareerTelemetry.log(.lineageMasteryRankedUp, [
            ...
            CareerTelemetry.log(.lifeCompleted, [
                "life_number": current.snapshot.lifeNumber,
