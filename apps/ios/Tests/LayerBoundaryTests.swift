...
final class LayerBoundaryTests: XCTestCase {
    ...
    func testFeatureViewsDoNotCallJourneyRuleEngines() throws {
        ...
        XCTAssertFalse(source.contains("SabermetricsRules."), "views must use MobileCareerStore projections")
        ...
        XCTAssertFalse(source.contains("ProContractMarketRules."), "views must use CareerDisplayRules")
    ...
    func testPresentationDoesNotCreateCareerEngines() throws {
        ...
        XCTAssertFalse(source.contains("SabermetricsRules."))
