...
final class AnalyticsContextTests: XCTestCase {
    ...
    func testNewFunnelEventNamesAreStable() {
        ...
        XCTAssertEqual(GameAnalytics.Event.lineageIdentityShown.rawValue, "lineage_identity_shown")
        XCTAssertEqual(GameAnalytics.Event.lineageComparisonSeen.rawValue, "lineage_comparison_seen")
        XCTAssertEqual(GameAnalytics.Event.rebirthEchoSeen.rawValue, "rebirth_echo_seen")
        XCTAssertEqual(GameAnalytics.Event.lineageMasteryEquipped.rawValue, "lineage_mastery_equipped")
        XCTAssertEqual(GameAnalytics.Event.lineageArchiveOpened.rawValue, "lineage_archive_opened")
