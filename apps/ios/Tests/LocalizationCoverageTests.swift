...
final class LocalizationCoverageTests: XCTestCase {
    ...
    func testPrologueStaticCatalogHasExactKoreanCopyAndEnglishCoverage() throws {
        ...
        let expectedKorean: [GameCopyKey: String] = [
            ...
            AppCopyKey.prologueAbilityNoCeiling: "기본 능력 완성",
    ...
    private func expectedHighSchoolSetupKoreanCopy() -> [GameCopyKey: String] {
        [
            ...
            AppCopyKey.setupInheritanceShopDescription: "지난 생에서 모은 계승 포인트로 이번 생의 규칙을 고릅니다. 이미 쌓인 자동 성장 보너스는 줄지 않습니다.",
            ...
            AppCopyKey.setupRepertoireTitle: "어떤 구종으로 시작할까요?",
            ...
            AppCopyKey.setupHandicapDescription: "최대 2개. 이번 고교 3년이 어려워지는 대신 다음 생에 이어갈 힘이 커집니다. 지금 +%lld%%",
