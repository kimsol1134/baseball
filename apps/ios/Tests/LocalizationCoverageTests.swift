...
final class LocalizationCoverageTests: XCTestCase {
    ...
    func testClosedEnumCatalogHasKoreanParityAndNaturalEnglishForEveryCase() throws {
        ...
        let expectedKorean: [(PresentationCopyFamily, [String])] = [
            ...
            (.proCareerPhase, ["계약 제안", "주간 계획", "시즌 결정", "중요 경기", "시즌 복기", "오프시즌 결정", "은퇴 결정", "완료"]),
            (.proLevel, ["2군", "1군"]),
            ...
            (.proSeasonDecisionType, ["추가 불펜", "포수와 경기 계획", "역할 면담", "기록 추격", "라이벌 분석", "시즌 막바지"]),
    ...
    private func expectedHighSchoolSetupKoreanCopy() -> [GameCopyKey: String] {
        [
            ...
            AppCopyKey.setupBoostExtraMemoryTitle: "기억 확장",
            AppCopyKey.setupBoostExtraMemoryDetail: "이번에 가져갈 기억이 %lld장에서 %lld장으로 늘어납니다.",
