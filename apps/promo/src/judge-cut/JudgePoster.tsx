...
export const JudgePoster: React.FC = () => (
  <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#050807" }}>
    ...
    <div style={{ position: "absolute", right: 86, top: 106, width: 520, height: 520, display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gridTemplateRows: "repeat(3, 1fr)", border: "3px solid rgba(238,240,223,0.65)", backgroundColor: "rgba(5,8,7,0.7)", boxShadow: "0 36px 100px rgba(0,0,0,0.64)" }}>
      ...
      <div style={{ position: "absolute", right: 23, bottom: 18, color: "#C8F24A", fontFamily: fontStack, fontSize: 22, fontWeight: 950 }}>RELEASE 22.4%</div>
    </div>
    <div style={{ position: "absolute", left: 82, right: 82, bottom: 66, display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", gap: 22 }}>
      <div style={{ padding: "24px 28px", border: "1px solid rgba(121,201,207,0.45)", backgroundColor: "rgba(5,8,7,0.9)" }}><small style={{ color: "#79C9CF", fontFamily: fontStack, fontSize: 20, fontWeight: 900 }}>LIFE 01</small><strong style={{ display: "block", marginTop: 8, color: "#EEF0DF", fontFamily: fontStack, fontSize: 36 }}>무명의 신인 · 첫 지명</strong></div>
      <strong style={{ color: "#C8F24A", fontFamily: fontStack, fontSize: 54 }}>→</strong>
      <div style={{ padding: "24px 28px", border: "2px solid rgba(200,242,74,0.62)", backgroundColor: "rgba(200,242,74,0.1)" }}><small style={{ color: "#C8F24A", fontFamily: fontStack, fontSize: 20, fontWeight: 900 }}>LIFE 02</small><strong style={{ display: "block", marginTop: 8, color: "#EEF0DF", fontFamily: fontStack, fontSize: 36 }}>기억과 야구혼을 잇는 새 선수</strong></div>
    </div>
  </AbsoluteFill>
);
