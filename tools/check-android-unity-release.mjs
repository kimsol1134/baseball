...
for (const contract of [
  ...
  "CrashReporterReadyTimeoutSeconds",
  "reporter_not_ready",
  "reporter_ready=true",
...
for (const contract of [
  ...
  "Generation of the Firebase Android resource file .* failed",
...
for (const contract of [
  ...
  "logcat -b crash -c",
  "crash_dump64",
  "18-qa-crash-buffer-after-clear.txt",
  "name=nonfatal_invoked status=passed reporter_ready=true",
